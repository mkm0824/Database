...
SELECT * FROM EMPLOYEES WHERE FIRST_NAME = 'Steven'; -- 데이터는 대소문자
...
SELECT * FROM EMPLOYEES WHERE FIRST_NAME LIKE '_ar%'; --는 자리수
SELECT * FROM EMPLOYEES WHERE HIRE_DATE LIKE '___0 5%';
...
SELECT FIRST-NAME, SALARY * 12 AS 연봉 FROM EMPLOYEES WHERE 연봉 >= 10000; -- WHERE 사용 X

SELECTFIRST_NAME, SALARY FROM EMPLOYEES WHERE DEPARTMENT_ID = 50 ORDER BY FIRST_NAME;
